...
import { LayoutTemplate, X, Menu, Zap, Download } from 'lucide-react'
...
const LandingPage = () => {
    ...
    const openATS = () => {
        window.open('https://ats-tau-eosin.vercel.app/', '_blank')
    }
            ...
            <main className={landingPageStyles.main}>
                    ...
                    <div className={landingPageStyles.heroGrid}>
                        <div className={landingPageStyles.heroLeft}>
                            ...
                            <h1 className={landingPageStyles.heading}>
                                <span className={landingPageStyles.headingText}>Create Stunning</span>
                                <span className={landingPageStyles.headingGradient}>Resumes</span>
                            </h1>
                            <p className={landingPageStyles.description}>
                                Transform your career with our AI-powered resume builder. Choose from beautiful templates, 
                            ...
                            <div className={landingPageStyles.ctaButtons}>
                                <button className={landingPageStyles.primaryButton}
                                    ...
                                    <div className={landingPageStyles.primaryButtonContent}>
                                        ...
                                        <LayoutTemplate className={landingPageStyles.primaryButtonIcon} size={20} />
                                    </div>
                                </button>
                ...
                <section className={landingPageStyles.featuresSection}>
                    <div className={landingPageStyles.featuresContainer}>
                        <div className={landingPageStyles.featuresHeader}>
                            <h2 className={landingPageStyles.featuresTitle}>
                                Check your <span className={landingPageStyles.featuresTitleGradient}>ATS Score</span>
                            </h2>
                            <p className={landingPageStyles.featuresDescription}>
                                Upload your resume PDF and a job description to see how well they match.
                            </p>
                            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '16px' }}>
                                <button
                                    onClick={openATS}
                                    className={`${landingPageStyles.secondaryButton} group relative overflow-hidden rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-all duration-300 px-6 py-3`}
                                >
                                    <span className="absolute -inset-px rounded-xl bg-gradient-to-r from-violet-500/50 to-fuchsia-500/50 blur-md opacity-30 group-hover:opacity-60 transition-opacity"></span>
...
<footer className={landingPageStyles.footer}>
    <div className={landingPageStyles.footerContainer}>
        <p className={landingPageStyles.footerText}>
            ...
            <a href="https://abhishekhosamaniportfolio.framer.website/" target='_blank' className={landingPageStyles.footerLink}>
                Abhishek Portfolio
            </a>
        </p>
    </div>
