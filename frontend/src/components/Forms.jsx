...
export const ProjectDetailForm = ({ projectInfo, updateArrayItem, addArrayItem, removeArrayItem, onEnhanceProjectDescription }) => {
  return (
...
export const WorkExperienceForm = ({ workExperience, updateArrayItem, addArrayItem, removeArrayItem, onEnhanceDescription }) => {
  return (
