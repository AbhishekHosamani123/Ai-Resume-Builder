...
export const buttonStyles = {
  ...
  skip: "flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-100/80 hover:bg-slate-200/90 px-5 py-2.5 text-sm font-semibold text-slate-700 transition-all cursor-pointer shadow-xs",
